...
public class FinanceController {
    ...
    public FinanceController(TransactionRepository repo) {
        this.repo = repo;
    }

    @GetMapping
    public ResponseEntity<PageResponse<Transaction>> list(@RequestParam(name = "page", defaultValue = "0") int page, @RequestParam(name = "size", defaultValue = "20") int size) {
